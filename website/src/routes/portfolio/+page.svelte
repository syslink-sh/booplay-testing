...
import { fetchPortfolioData, PORTFOLIO_DATA } from "$lib/stores/portfolio-data";
...
const sendMoneyModalOpen = $state(false);
...
const transactionsColumns = $derived([
	{
		key: "type",
		label: $_("global.type"),
...
<SEO
	title="Portfolio - BooPlay"
	description="View your virtual cryptocurrency portfolio, simulated holdings, and trading performance in the Booplay simulation game platform."
	noindex={true}
